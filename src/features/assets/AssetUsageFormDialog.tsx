...
interface AssetUsageFormDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function AssetUsageFormDialog({ open, onOpenChange }: AssetUsageFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent title={t("assetUsage.formTitle")} className="max-w-lg">
